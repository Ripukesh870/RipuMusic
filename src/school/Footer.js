        ...
        <div className='SC_continer_footer'>
          ...
          <div className='SC_inner_container1_foter'>
            ...
            <div className="SC_inner_container12_footer">
              <h5>Contact Us</h5>
              <p><HomeIcon className='SC_footer_icon' />  P.P.M School Venkateshwar Nagar, Arwal More, Jehanabad-804408</p>
              <p><PhoneIcon className='SC_footer_icon' /> 06004-220022, 9430000054, 9300000096</p>
